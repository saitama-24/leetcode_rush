package techniques.two_pointers.expressive_words;

/**
 * @author wangzhenjie
 * @version 1.0
 * @date 2022/11/25 21:10
 * @className: AC1
...
public class AC1 {
    ...
    static class Solution {
        ...
        private static String getMatchStr(String s) {
        ...
        public static void main(String[] args) {
            System.out.println(expressiveWords("heeellooo", new String[]{
                    "hello", "hi", "helo"
            }));
        }
    }
